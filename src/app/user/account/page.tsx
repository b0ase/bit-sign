...
import {
  ...
  FiShield, FiMail, FiUpload, FiSettings
} from 'react-icons/fi';
    ...
    return (
      <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-6 text-center">
        ...
        <p className="text-zinc-400 mb-8 max-w-md text-base leading-relaxed">
          Connect your HandCash wallet to access your dashboard.
        </p>
        <a
      ...
      <div className="relative z-10 p-6 pt-24 max-w-6xl mx-auto space-y-12 pb-40">
          ...
          <div className="flex items-center gap-3">
            ...
            <label className="relative group cursor-pointer">
              <input
                ...
                onChange={(e) => {
                  if (e.target.files?.[0]) {
                    // Navigate to new document page — uploading handled there
        ...
        <footer className="pt-16 border-t border-zinc-900 space-y-6">
          <div className="flex justify-between items-center opacity-60 hover:opacity-100 transition-opacity">
            ...
            >
              <FiSettings size={12} /> Advanced Identity Settings
            </Link>
            <a
